...
double maxNumber = Convert.ToInt32(Console.ReadLine()); // 10
...
//   } 
    if (userResponse == "higher") 
    {
      ...
      lowestSoFar = machineGuess; // 5
      machineGuess = Math.Round(machineGuess + machineGuess/2); // 8
      Console.WriteLine("Your number is " + machineGuess);
      userResponse = Console.ReadLine();
      }
    ...
    highestSoFar = machineGuess; // (8)
    machineGuess = Math.Round(machineGuess - (machineGuess - lowestSoFar) / 2); // 6,5 -> 7
    Console.WriteLine("Your number is " + machineGuess);
    userResponse = Console.ReadLine();
      }
  }
